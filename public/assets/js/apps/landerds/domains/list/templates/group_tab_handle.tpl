<span class="open_sidemenu_r">
	<span style="position: relative; top: 4px" class="fs20 icon-groups_icon"></span>

	<span style="font-size: 12px; line-height: 29px"><%= active_groups_count %> <% if(active_groups_count > 1 || active_groups_count == 0) { %>Groups <% } else { %>Groups <% } %></span>
</span>
