<div class="row mb15 table-layout">
  <div class="col-xs-6 va-m pln">
    <a href="#" title="Return to Dashboard">
      <img src="/assets/images/logos/LanderDSWhite3.png" title="Lander DS Logo" class="img-responsive w200">
    </a>
  </div>
    ...
    <div class="panel-body bg-light p30">
      <div class="row">
        ...
        <div class="col-sm-5 br-l br-grey pl20">
          <img style="width: 295px; margin: 25px 0 10px" src="assets/images/logos/logintaglinecheck.png" />
        </div>
      </div>
    </div>
