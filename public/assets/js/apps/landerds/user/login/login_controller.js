define(["app", "assets/js/apps/landerds/user/login/login_view",
    "assets/js/apps/landerds/user/login/login_layout",
    "assets/js/apps/landerds/user/login/reset_password_view",
    "assets/js/apps/landerds/user/login/models/reset_password_model",
    "assets/js/apps/landerds/common/logout/common_logout",
