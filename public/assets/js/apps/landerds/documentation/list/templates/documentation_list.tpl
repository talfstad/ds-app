        ...
        <div id="docs-content" class="tab-content pn">
          ...
          <div class="tab-pane fade" id="rip-and-add-lander" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/rip.lander.png" alt="Rip Lander" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/add.lander.png" alt="Rip Lander" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/zip.png" alt="Zip" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          <!-- OPTIMIZATION -->
          <div class="tab-pane fade" id="optimization" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/google.pagespeed.png" alt="Google Pagespeed">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/yslow.png" alt="YSlow">
              </div>
            </div>
          </div>
          <!-- EDIT -->
          ...
          <div class="tab-pane fade" id="snippets" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/snippet.png" alt="Snippet" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="other-right-hand-panel-actions" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/deployment.folder.png" alt="Copy" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/copy.png" alt="Copy" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/save.png" alt="Preview" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/preview.png" alt="Preview" style="width:640px;height:360px;">
                <br>
                <br>
                <img src="/assets/images/documentation/preview1.png" alt="Preview" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/download.png" alt="Download" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/delete.lander.png" alt="Delete" style="width:640px;height:360px;">
                <br>
                <br>
                <img src="/assets/images/documentation/broken.png" alt="Delete" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          <!-- DEPLOY -->
          <div class="tab-pane fade" id="deploy" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/lander.deploy.png" alt="Deploy Lander" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/deploy.domain.lander.png" alt="Deploy Lander" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          <!-- GROUPS - GENERAL -->
          ...
          <div class="tab-pane fade" id="groups-set-up" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/add.group.png" alt="Add Groups" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="groups-landing-pages" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/groups.png" alt="Groups" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/add.lander.group.png" alt="Groups" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          <!-- GROUPS - DOMAINS -->
          <div class="tab-pane fade" id="groups-domains" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <p> 1. Click on the domain you'd like to add to a group to.
                ...
                <br>5. Click the blue "Add Group" on the bottom right corner of the pop-up.</p>
              <div class="bs-example">
                <img src="/assets/images/documentation/deploy.group.png" alt="Groups" style="width:640px;height:360px;">
              </div>
              <h3> Option 2: From Groups</h3>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/deploy.group.domain.png" alt="Groups" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
          <!-- DOMAINS - SET-UP -->
          <div class="tab-pane fade" id="domains-set-up" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/add.domain.1.png" alt="Add Domain" style="width:640px;height:360px;" vspace="20">
                <img src="/assets/images/documentation/add.domain.png" alt="Add Domain" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/subdomain.png" alt="Add Domain" style="width:640px;height:360px;">
              </div>
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/add.nameservers.png" alt="Update Nameservers" style="width:640px;height:360px;">
              </div>
          ...
          <div class="tab-pane fade" id="notes-general" role="tabpanel">
            ...
            <div class="bs-docs-section">
              ...
              <div class="bs-example">
                <img src="/assets/images/documentation/notes.png" alt="Notes" style="width:640px;height:360px;">
              </div>
            </div>
          </div>
