define(["app",
    "tpl!assets/js/apps/landerds/groups/add_new_domain/templates/domains_list.tpl",
    "bootstrap.datatables"
  ],
  function(Landerds, domainsListTpl) {
        ...
        onRender: function() {
          ...
          this.$el.find('#domains-list-datatable').dataTable({
            ...
            "oLanguage": {
              ...
              "sZeroRecords": "This group is already deployed on all your domains."
            },
    ...
    return Landerds.LandersApp.DeployToDomain.List.View;
  });
