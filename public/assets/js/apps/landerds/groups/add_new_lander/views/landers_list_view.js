define(["app",
    "tpl!assets/js/apps/landerds/groups/add_new_lander/templates/landers_list.tpl",
  ...
  function(Landerds, landersListTpl) {
        ...
        onRender: function() {
          ...
          this.$el.find('#landers-list-datatable').dataTable({
            ...
            "oLanguage": {
              ...
              "sZeroRecords": "All landers have been deployed to this group."
            },
    ...
    return Landerds.GroupsApp.Groups.AddNewLander.View;
  });
