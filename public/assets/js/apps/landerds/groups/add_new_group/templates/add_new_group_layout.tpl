<div class="modal-dialog modal-lg">
  <div class=" modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Add a New Groups</h4>
    </div>
    <div class="groups-list-region modal-body">
      ...
      <div class="panel panel-primary top mb35">
        <div class="panel-heading">
          <span class="panel-title">New Groups Information</span>
        </div>
        <div class="panel-body bg-light dark">
          <div class="admin-form">
            <div class="section row mb10">
              <label for="groupName" class="text-align-right field-label col-md-3 text-center">Groups Name:</label>
              <div class="col-md-9">
    ...
    <div class="modal-footer">
      ...
      <button type="submit" class="add-new-group-confirm btn btn-primary btn-clipboard">Add Groups</button>
    </div>
  </div>
</div>
