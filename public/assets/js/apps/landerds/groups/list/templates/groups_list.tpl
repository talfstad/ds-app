          ...
          <ul class="dropdown-menu dropdown-menu-left pt5" role="menu">
            <li>
              <a class="pl5 radio-custom radio-primary" href="#">
                <input checked data-sort-by="group-name" value="10" id="10-pages-radio" type="radio" name="pages-radio">
                <label class="ml5" for="10-pages-radio">10 Rows Per Page</label>
              </a>
            </li>
            <li>
              <a class="pl5 radio-custom radio-primary" href="#">
                <input value="20" data-sort-by="group-name" id="20-pages-radio" type="radio" name="pages-radio">
