define(["app",
    "tpl!assets/js/apps/landerds/groups/list/templates/domain_tab_handle.tpl"
  ],
  function(Landerds, domainTabHandleTpl) {
    ...
    Landerds.module("GroupsApp.Groups.List.CollectionView.RowView", function(RowView, Landerds, Backbone, Marionette, $, _) {
      RowView.DomainTabHandle = Marionette.ItemView.extend({
        ...
        addNewDomain: function() {
          Landerds.trigger("groups:showAddNewDomain", this.model);
        },
    ...
    return Landerds.GroupsApp.Groups.List.CollectionView.RowView.DomainTabHandle;
  });
