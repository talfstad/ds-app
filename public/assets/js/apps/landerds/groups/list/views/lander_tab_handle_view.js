define(["app",
    "tpl!assets/js/apps/landerds/groups/list/templates/landers_tab_handle.tpl"
  ],
  function(Landerds, landersStatusTpl) {

    Landerds.module("GroupsApp.Groups.List.CollectionView.RowView", function(RowView, Landerds, Backbone, Marionette, $, _) {
      RowView.LanderTabHandle = Marionette.ItemView.extend({
        ...
        addNewLander: function(e) {
          Landerds.trigger("groups:showAddNewLander", this.model);
        },
    ...
    return Landerds.GroupsApp.Groups.List.CollectionView.RowView.LanderTabHandle;
  });
