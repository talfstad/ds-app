define(["app",
    "tpl!assets/js/apps/landerds/landers/js_snippets/templates/snippet_detail.tpl",
  ...
  function(Landerds, SnippetDetailTpl, CodeMirror) {
    ...
    Landerds.module("LandersApp.Landers.JsSnippets.List.DetailView", function(DetailView, Landerds, Backbone, Marionette, $, _) {
      DetailView.View = Marionette.ItemView.extend({
        ...
        onRender: function() {
          ...
          var modalHeight = parseInt($(".modal-dialog.snippets-modal").css("height"));
    ...
    return Landerds.LandersApp.Landers.JsSnippets.List.DetailView.View;
  });
