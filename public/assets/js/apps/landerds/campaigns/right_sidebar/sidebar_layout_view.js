define(["app",
    "tpl!assets/js/apps/landerds/campaigns/right_sidebar/templates/sidebar_campaigns.tpl",
    "bootstrap"
  ],
  function(Landerds, sidebarLanders) {
    ...
    Landerds.module("CampaignsApp.RightSidebar", function(RightSidebar, Landerds, Backbone, Marionette, $, _) {
      ...
      RightSidebar.View = Marionette.LayoutView.extend({
        ...
        showRemoveCampaignModal: function() {
          Landerds.trigger("campaigns:showRemoveCampaign", this.model);
        },
    ...
    return Landerds.CampaignsApp.RightSidebar.View;
  });
