define(["app",
    "tpl!assets/js/apps/landerds/campaigns/add_new_lander/templates/landers_list.tpl",
  ...
  function(Landerds, landersListTpl) {
    ...
    Landerds.module("CampaignsApp.Campaigns.AddNewLander", function(AddNewLander, Landerds, Backbone, Marionette, $, _) {
      AddNewLander.View = Marionette.ItemView.extend({
        ...
        onRender: function() {
          ...
          this.$el.find('#landers-list-datatable').dataTable({
            ...
            "oLanguage": {
              ...
              "sZeroRecords": "All landers have been deployed to this campaign."
            },
            //set the lander id on the row so we can use it to know which to deploy to
            //in the layout view
    ...
    return Landerds.CampaignsApp.Campaigns.AddNewLander.View;
  });
