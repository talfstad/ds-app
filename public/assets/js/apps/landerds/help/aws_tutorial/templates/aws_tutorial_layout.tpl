  ...
  <div class=" modal-content">
    ...
    <div class="group-list-region modal-body">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <img style="width: 271px" src="/assets/images/tutorials/identityaccessmanagement.png" alt="Identity And Access Management thumbnail" />
        </div>
      </div>
      <div class="row mt20">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <img style="width: 400px" src="/assets/images/tutorials/usersiamresources.png" alt="users link thumbnail" />
        </div>
      </div>
      <div class="row mt20">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <img style="width: 530px" src="/assets/images/tutorials/createnewuseraws.png" alt="users link thumbnail" />
        </div>
      </div>
      <div class="row mt20">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <img style="width: 428px" src="/assets/images/tutorials/usercredentials.png" alt="users link thumbnail" />
        </div>
      </div>
      <div class="row mt20">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <img style="width: 410px" src="/assets/images/tutorials/usersettings.png" alt="users link thumbnail" />
        </div>
      </div>
      <div class="row mt20">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <img style="width: 510px" src="/assets/images/tutorials/selectpolicy.png" alt="users link thumbnail" />
        </div>
      </div>
