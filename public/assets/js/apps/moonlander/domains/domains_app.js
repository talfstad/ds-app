define(["app", 
    "assets/js/apps/moonlander/domains/list/list_controller",
    "assets/js/common/login/common_login",
    "assets/js/apps/moonlander/domains/right_sidebar/sidebar_controller",
    "assets/js/apps/moonlander/domains/add_new_domain/add_new_domain_controller",
    "assets/js/apps/moonlander/domains/deploy_new_lander/deploy_new_lander_controller",
    "assets/js/apps/moonlander/domains/delete_domain/delete_domain_controller",
    "assets/js/apps/moonlander/domains/undeploy_lander/undeploy_controller",
    "assets/js/apps/moonlander/domains/add_to_campaign/add_to_campaign_controller",
    "assets/js/apps/moonlander/domains/undeploy_campaign/undeploy_controller"
  ],
