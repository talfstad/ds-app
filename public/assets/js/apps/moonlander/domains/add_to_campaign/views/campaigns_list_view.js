define(["app",
    "tpl!assets/js/apps/moonlander/domains/add_to_campaign/templates/campaigns_list.tpl",
  ...
  function(Moonlander, campaignsListTpl) {
        ...
        onRender: function() {
          ...
          this.$el.find('#campaigns-list-datatable').dataTable({
            ...
            "oLanguage": {
              ...
              "sZeroRecords": "This domain already belongs to all of your campaigns."
            },
    ...
    return Moonlander.DomainsApp.AddToCampaign.List.View;
  });
