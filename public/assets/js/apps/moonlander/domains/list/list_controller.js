define(["app",
    "assets/js/apps/moonlander/domains/list/views/list_view",
    ...
    "assets/js/apps/moonlander/domains/list/views/topbar_view",
    "assets/js/apps/moonlander/domains/list/views/loading_view",
    "assets/js/apps/moonlander/domains/list/views/lander_tab_handle_view",
    "assets/js/apps/moonlander/domains/list/views/campaign_tab_handle_view",
    "assets/js/apps/moonlander/domains/list/deployed_landers/views/deployed_landers_collection_view",
    "assets/js/apps/moonlander/domains/dao/domain_collection",
    "assets/js/apps/moonlander/domains/list/active_campaigns/views/active_campaigns_collection_view",
    "assets/js/apps/moonlander/domains/dao/deployed_lander_model",
    "assets/js/jobs/jobs_model",
    "assets/js/apps/moonlander/domains/dao/active_campaign_model",
    "assets/js/apps/moonlander/domains/list/views/list_layout_view"
  ],
