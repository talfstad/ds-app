...
<button type="button" style="width: 88px" class="redeploy-all-locations <% if(!modified) { %>disabled<% } %> btn btn-default btn-gradient dark"><span class="fa fa-upload pr5"></span>Deploy</button>
