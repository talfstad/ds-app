define(["app",
    "tpl!/assets/js/apps/moonlander/domains/right_sidebar/js_snippets/templates/url_endpoint_active_snippet_list.tpl",
    "/assets/js/apps/moonlander/domains/right_sidebar/js_snippets/views/active_snippet_view.js"
  ],
  function(Moonlander, UrlEndpointActiveSnippetListTpl, ActiveSnippetView) {
    ...
    return Moonlander.DomainsApp.RightSidebar.JsSnippets.List.UrlEndpointSnippetsView;
  });
