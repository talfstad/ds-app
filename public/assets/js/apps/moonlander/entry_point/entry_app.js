define(["app",
    "assets/js/apps/moonlander/entry_point/entry_controller",
    "assets/js/apps/moonlander/header/header_app",
    "assets/js/apps/moonlander/domains/domains_app",
    "assets/js/apps/moonlander/landers/landers_app",
    "assets/js/apps/moonlander/campaigns/campaigns_app"
  ],
