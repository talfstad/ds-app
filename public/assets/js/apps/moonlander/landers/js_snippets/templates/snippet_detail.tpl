<header class="snippets-header">
  <div class="snippet-name-container">
    ...
    <div style="float: left; margin-top: 4px; font-size: 12px">
      ...
      <% if(!editing) { %>
        <button type="button" class="edit-snippet-button ml10 pl10 pt5 mr10 pb5 btn btn-default btn-gradient dark">
          <span class="fa fa-file-code-o pr5"></span>Edit
        </button>
        <% } else { %>
          <button type="button" class="show-description-button ml10 pl10 pt5 mr10 pb5 btn btn-default btn-gradient dark">
