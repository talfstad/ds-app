define(["app",
    "assets/js/apps/moonlander/landers/js_snippets/views/js_snippets_layout_view",
    "assets/js/apps/moonlander/landers/js_snippets/views/loading_view",
    "assets/js/apps/moonlander/landers/js_snippets/views/js_snippets_list_view",
    "assets/js/apps/moonlander/landers/dao/js_snippet_model",
    "assets/js/apps/moonlander/landers/js_snippets/views/js_snippets_detail_view",
    "assets/js/common/filtered_paginated/filtered_paginated_collection",
    "assets/js/apps/moonlander/landers/js_snippets/views/js_snippets_totals_view",
    "assets/js/apps/moonlander/landers/right_sidebar/js_snippets/dao/active_js_snippet_model",
    "assets/js/apps/moonlander/landers/js_snippets/views/empty_snippets_detail_view",
    "assets/js/apps/moonlander/landers/js_snippets/views/create_new_snippet_view",
    "assets/js/apps/moonlander/landers/dao/js_snippet_collection"
  ],
