define(["app", 
    "assets/js/apps/moonlander/campaigns/list/list_controller",
    "assets/js/common/login/common_login",
    "assets/js/apps/moonlander/campaigns/right_sidebar/sidebar_controller",
    "assets/js/apps/moonlander/campaigns/add_new_campaign/add_new_campaign_controller",
    "assets/js/apps/moonlander/campaigns/add_new_lander/add_new_lander_controller",
    "assets/js/apps/moonlander/campaigns/add_new_domain/add_new_domain_controller",
    "assets/js/apps/moonlander/campaigns/remove_lander/remove_lander_controller",
    "assets/js/apps/moonlander/campaigns/remove_domain/remove_domain_controller",
    "assets/js/apps/moonlander/campaigns/remove_campaign/remove_campaign_controller",
  ],
