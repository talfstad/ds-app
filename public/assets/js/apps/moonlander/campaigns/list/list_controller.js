define(["app",
    "assets/js/apps/moonlander/campaigns/list/views/list_view",
    ...
    "assets/js/apps/moonlander/campaigns/list/views/topbar_view",
    "assets/js/apps/moonlander/campaigns/list/views/loading_view",
    "assets/js/apps/moonlander/campaigns/list/views/lander_tab_handle_view",
    "assets/js/apps/moonlander/campaigns/list/views/domain_tab_handle_view",
    "assets/js/apps/moonlander/campaigns/list/deployed_landers/views/deployed_landers_collection_view",
    "assets/js/apps/moonlander/campaigns/list/deployed_domains/views/deployed_domains_collection_view",
    "assets/js/apps/moonlander/campaigns/dao/deployed_lander_model",
    "assets/js/apps/moonlander/campaigns/dao/deployed_domain_model",
    "assets/js/jobs/jobs_model",
    "assets/js/apps/moonlander/campaigns/dao/campaign_collection",
    "assets/js/apps/moonlander/campaigns/list/views/list_layout_view"
  ],
