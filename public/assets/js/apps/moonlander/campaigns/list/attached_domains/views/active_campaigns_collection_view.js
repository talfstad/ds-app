define(["app",
    "/assets/js/apps/moonlander/campaigns/list/active_campaigns/views/active_campaign_row_view.js",
    "/assets/js/apps/moonlander/campaigns/list/active_campaigns/views/active_campaign_empty_view.js"
  ],
  function(Moonlander, ActiveCampaignRowView, EmptyView) {
    ...
    return Moonlander.CampaignsApp.Campaigns.List.ActiveCampaigns.ChildView;
  });
