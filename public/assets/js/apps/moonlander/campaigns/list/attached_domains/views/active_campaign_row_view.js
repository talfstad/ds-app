define(["app",
    "tpl!/assets/js/apps/moonlander/campaigns/list/active_campaigns/templates/active_campaign_row.tpl"
  ],
  function(Moonlander, ActiveCampaignRowTpl) {
    ...
    return Moonlander.CampaignsApp.Campaigns.List.ActiveCampaigns.ActiveCampaignRowView;
  });
