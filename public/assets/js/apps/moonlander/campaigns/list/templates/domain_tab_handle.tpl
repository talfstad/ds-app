<span class="open_sidemenu_r">
	<span style="position: relative; top: 4px" class="fs20 icon-domains_icon"></span>
<span style="font-size: 12px; line-height: 29px"><%= deployed_domains_count %> <% if(deployed_domains_count > 1 || deployed_domains_count == 0) { %>Domains <% } else { %>Domain <% } %></span>
</span>
