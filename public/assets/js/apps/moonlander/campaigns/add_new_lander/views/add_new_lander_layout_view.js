define(["app",
    "tpl!assets/js/apps/moonlander/campaigns/add_new_lander/templates/add_new_lander_layout.tpl"
  ],
  function(Moonlander, AddNewLanderLayout) {
    ...
    return Moonlander.CampaignsApp.Campaigns.AddNewLander.Layout;
  });
