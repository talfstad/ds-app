define(["app",
    "tpl!assets/js/apps/moonlander/campaigns/add_new_campaign/templates/add_new_campaign_layout.tpl",
    "bootstrap.fileinput",
    "syphon"
  ],
  function(Moonlander, AddNewCampaignLayoutTpl) {
    ...
    return Moonlander.CampaignsApp.Campaigns.AddNewCampaign.Layout;
  });
