	...
	<div class=" modal-content">
    	...
    	<div class="campaigns-list-region modal-body">
            ...
            <div class="tab-content">
                ...
                <div class="alert alert-micro alert-border-left alert-default aws-info-alert">
                  <i class="fa fa-info pr10"></i>
                  We use your AWS settings to manage and organize your landers. <a href="#" class="alert-link">Where do I find my keys?</a>
                </div>
