      ...
      var addExtraToJob = function(addExtraCode, activeJob, callback) {
        ...
        if (!addExtraCode) {
          ...
          if (addExtraCode == "finishedSavingLander") {
            ...
            base.landers.getPagespeedScoresForLander(user, lander_id, function(err, pagespeed_scores) {
              if (err) {
                callback(err);
              } else {
            ...
            base.landers.getDeployedDomainsForLander(user, lander_id, function(err, dbDeployedDomains) {
              if (err) {
                callback(err);
              } else {
