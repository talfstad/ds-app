...
<td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            ...
            <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;"><strong>NOTICE: This link is valid for 10 minutes.</strong> <br />The link below will allow you to reset your LanderDS password. Once you've done that, you can log in with the email you provided at sign up.</p>
            <!-- button -->
...
<!-- /button --><p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0;">If you have any further questions, please don't hesitate to chat with us once you've logged back in.</p>
