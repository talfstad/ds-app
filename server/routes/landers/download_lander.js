                    ...
                    find.file(staging_path, function(files) {
                      ...
                      for (var i = 0; i < files.length; i++) {
                        ...
                        if (app.config.noGzipArr.indexOf(ext) <= -1) {
                          //-N restore original name, -f force overwrite, --uncompress, -S use suffix
                          //gzip -N --uncompress -f -S .html index.html
                          cmd.get('nice gzip -N -f --uncompress -S .' + ext + ' ' + file, function(data) {
