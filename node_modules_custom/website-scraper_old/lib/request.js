...
function makeRequest(options, url) {
  ...
  //test the url without search query on it
  //   var urlParsed = url_parser.parse(url);
  //   // console.log("urlOrig: " + url);
  //   // console.log("url search: " + urlParsed.search);
  //   var urlBase = url.replace(urlParsed.search, '');
  //   urlBase = urlBase.replace(/\#$/,'');

  // if (path.extname(urlBase) == ".html" || path.extname(urlBase) == ".php" || urlBase.substr(urlBase.length - 1) === "/") {
